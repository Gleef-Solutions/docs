...
My first experiment became significant, what can I do now?
First of all, congrats! 👏

### Implement the winning variation
Start by using the experiment learnings to maximize your conversion on the finished product. Unfortunately, Gleef doesn't modify your definitive wording yet. Use your regular localization software, your CMS or contact your development team.
...
<Info>
    As a reminder, experiments on the same page are mutually exclusive. By suspending an already significant experiment, you're routing more trafic to a non-significant experiments on the same page.
</Info>
