...
For detailed insight on how this is done, refer to our [statistics Q&A](/Q&A/statistics-data/#common-questions-about-statistics).
...
<Note>All significance parameters can be customized for your company.</Note>
...
<Info>We now display `p-value` and `Z-value` for all experiments, as well as extensive data points we use to compute significance.</Info>
