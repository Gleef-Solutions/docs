...
<Tip>You can now see `p-value`and `Z-value` by opening the console of the webpage.</Tip>
...
<Note>Significance is fixed at 95% for any experiment, and we do not offer the ability to change it yet.</Note>
