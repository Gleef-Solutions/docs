...
You have the flexibility to edit the `Test name` at any time, and regardless of the status of your experiment (`Draft`, `In Progress`, `Paused`, `Finished`).
<img width="200" src="/images/monitor_details.png" alt="Name edition"/>
Simply edit it and then save the changes.

<Note>To prevent bias in your experiment, you cannot modify anything except the name once it has been saved. For additional information, please visit our [FAQ](/Q&A/QA)</Note>
