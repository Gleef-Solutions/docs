...
<Info>Keep in mind that once these changes go live, the experiment may no longer function correctly, as the baseline text for the experiment will have changed.</Info>
