---
title: 'Best Practices when Using Gleef'
icon: 'circle-check'
iconType: 'solid'
---
...
Avoid running multiple overlapping experiments on the same page, as this can skew results. Isolate each experiment to a specific section of your website to ensure that changes are the only variable impacting user behavior.

<Tip>Don't worry, Gleef also manages multiple experiments on the same page. Learn how [here](/Q&A/QA#multiple-experiments)</Tip>
