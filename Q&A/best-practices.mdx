...
Changing variations or the success event while the experiment is still running will introduce bias in it, which will then lead to potential incoherences and not applicable results.
