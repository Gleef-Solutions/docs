...
This means that visitors, including yourself, will continue to see the same variation regardless of the experiment’s current status, which can be inconvenient if the experiment has been stopped.
